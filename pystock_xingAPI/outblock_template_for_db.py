...
#######################################################################################################################################
# 해외선물 옵션종목마스터 조회(o3121)
db_outblock_query_o3121={
	'o3121OutBlock' : {
		#종목코드
		'Symbol' : 'char',
		#종목명,SymbolNm
		...
		#옵션행사가,XrcPrc
		'XrcPrc' : 'char',
		#기초자산기준가격,FdasBasePrc
		'FdasBasePrc':'char',
		#옵션콜풋구분,OptTpCode
		'OptTpCode':'char',
		#권리행사구분코드,RgtXrcPtnCode
		'RgtXrcPtnCode':'char',
		#ATM구분,Moneyness
		'Moneyness':'char',
		#해외파생기초자산종목코드,LastSettPtnCode
		'LastSettPtnCode':'char',
		#해외옵션최소호가,OptMinOrcPrc
		'OptMinOrcPrc':'char',
		#해외옵션최소기준호가,OptMinBaseOrcPrc
		'OptMinBaseOrcPrc':'char'
	}
}

# 해외선물마스터조회(o3101)
db_outblock_query_o3101 = {
	'o3101OutBlock' : {
		'Symbol' : 'char' ,
		'SymbolNm' : 'char' ,
		'ApplDate' : 'char' ,
...
# 해외선물현재가(종목정보)조회(o3105)
db_outblock_query_o3105 = {
	'o3105OutBlock' : {
		'Symbol' : 'char' ,
		'SymbolNm' : 'char' ,
		'ApplDate' : 'char' ,
...
# 해외선물시간대별(Tick)체결(o3116)
db_outblock_query_o3116 = {
	'o3116OutBlock' : {
		'cts_seq' : 'long'
	},
	'o3116OutBlock1' : {
...
# 해외선물옵션현재가(종목정보)조회(o3125)
db_outblock_query_o3125 = {
	'o3125OutBlock' : {
		'Symbol' : 'char' ,
		'SymbolNm' : 'char' ,
		'ApplDate' : 'char' ,
		...
		'Diff' : 'double' ,
		'MinOrcPrc' : 'double' ,
		'MinBaseOrcPrc' : 'double'
	}
}
# 해외선물옵션현재가호가조회(o3126)
db_outblock_query_o3126 = {
	'o3126OutBlock' : {
		'symbol' : 'char' ,
		'symbolname' : 'char' ,
		'price' : 'double' ,
...
# 해외선물옵션시간대별(Tick)체결(o3136)
db_outblock_query_o3136 = {
	'o3136OutBlock' : {
		'cts_seq' : 'long'
	},
	'o3136OutBlock1' : {
...
# 해외선물옵션차트용NTick(o3137)
db_outblock_query_o3137 = {
	'o3137OutBlock' : {
		'shcode' : 'char' ,
		'rec_count' : 'long' ,
		'cts_seq' : 'char' ,
...
db_outblock_subscription_TC1 = {
	'OutBlock' : {
		...
		'ordr_ccd' : 'char' ,
		'ordr_typ_cd' : 'char' ,
		'ordr_typ_prd_ccd' : 'char' ,
		'ordr_aplc_strt_dt' : 'char' ,
		'ordr_aplc_end_dt' : 'char' ,
		'ordr_prc' : 'double' ,
		'cndt_ordr_prc' : 'double' ,
		'ordr_q' : 'long' ,
		'ordr_tm' : 'char' ,
		'userid' : 'char'
	}
...
db_outblock_query_CIDBQ01400 = {
	'CIDBQ01400OutBlock1' : {
		...
		'IsuCodeVal' : 'char' ,
		'BnsTpCode' : 'char' ,
		'OvrsDrvtOrdPrc' : 'double' ,
		'AbrdFutsOrdPtnCode' : 'char'
	},
	'CIDBQ01400OutBlock2' : {
		'RecCnt' : 'long' ,
		'OrdAbleQty' : 'long'
...
db_outblock_query_CIDBQ01500 = {
	...
	'CIDBQ01500OutBlock2' : {
		...
		'Dps' : 'long' ,
		'LpnlAmt' : 'double' ,
		'FutsDueBfLpnlAmt' : 'double' ,
		'FutsDueBfCmsn' : 'double' ,
		'CsgnMgn' : 'long' ,
		'MaintMgn' : 'long' ,
		'CtlmtAmt' : 'double' ,
		'AddMgn' : 'long' ,
		...
		'IsuNm' : 'char' ,
		'CrcyCodeVal' : 'char' ,
		'OvrsDrvtPrdtCode' : 'char' ,
		'OvrsDrvtOptTpCode' : 'char' ,
		'DueDt' : 'char' ,
		'OvrsDrvtXrcPrc' : 'double' ,
		'BnsTpCode' : 'char' ,
		'CmnCodeNm' : 'char' ,
		'TpCodeNm' : 'char' ,
		'BalQty' : 'long' ,
		'PchsPrc' : 'double' ,
		'OvrsDrvtNowPrc' : 'double' ,
		'AbrdFutsEvalPnlAmt' : 'double' ,
		'CsgnCmsn' : 'double' ,
		'PosNo' : 'char' ,
		'EufOneCmsnAmt' : 'double' ,
		'EufTwoCmsnAmt' : 'double'
	}
}
# 해외선물 주문체결내역 조회
db_outblock_query_CIDBQ01800 = {
	'CIDBQ01800OutBlock1' : {
		'RecCnt' : 'long' ,
		'AcntNo' : 'char' ,
		'Pwd' : 'char' ,
		...
		'QryTpCode' : 'char' ,
		'OrdPtnCode' : 'char' ,
		'OvrsDrvtFn,oTpCode' : 'char'
	},
	'CIDBQ01800OutBlock2' : {
		'OvrsFutsOrdNo' : 'char' ,
		'OvrsFutsOrgOrdNo' : 'char' ,
		'FcmOrdNo' : 'char' ,
		'IsuCodeVal' : 'char' ,
		'IsuNm' : 'char' ,
		'AbrdFutsXrcPrc' : 'double' ,
		'FcmAcntNo' : 'char' ,
		'BnsTpCode' : 'char' ,
		'BnsTpNm' : 'char' ,
		'FutsOrdStatCode' : 'char' ,
		'TpCodeNm' : 'char' ,
		'FutsOrdTpCode' : 'char' ,
		'TrdTpNm' : 'char' ,
		'AbrdFutsOrdPtnCode' : 'char' ,
		'OrdPtnNm' : 'char' ,
		'OrdPtnTermTpCode' : 'char' ,
		'CmnCodeNm' : 'char' ,
		'AppSrtDt' : 'char' ,
		'AppEndDt' : 'char' ,
		'OvrsDrvtOrdPrc' : 'double' ,
		'OrdQty' : 'long' ,
		'AbrdFutsExecPrc' : 'double' ,
		'ExecQty' : 'long' ,
		'OrdCndiPrc' : 'double' ,
		'OvrsDrvtNowPrc' : 'double' ,
		'MdfyQty' : 'long' ,
		...
		'OrdDt' : 'char' ,
		'OrdTime' : 'char' ,
		'OvrsOptXrcRsvTpCode' : 'char'
	}
}
# 해외선물 주문체결내역 상세 조회
db_outblock_query_CIDBQ02400 = {
	'CIDBQ02400OutBlock1' : {
		'RecCnt' : 'long' ,
		'AcntNo' : 'char' ,
		'Pwd' : 'char' ,
	...
	'CIDBQ02400OutBlock2' : {
		...
		'EufOneCmsnAmt' : 'double' ,
		'EufTwoCmsnAmt' : 'double' ,
		'LchOneCmsnAmt' : 'double' ,
		'LchTwoCmsnAmt' : 'double' ,
		'TrdOneCmsnAmt' : 'double' ,
		'TrdTwoCmsnAmt' : 'double' ,
		'TrdThreeCmsnAmt' : 'double' ,
		'StrmOneCmsnAmt' : 'double' ,
		'StrmTwoCmsnAmt' : 'double' ,
		'StrmThreeCmsnAmt' : 'double' ,
		'TransOneCmsnAmt' : 'double' ,
		'TransTwoCmsnAmt' : 'double' ,
		'TransThreeCmsnAmt' : 'double' ,
		'TransFourCmsnAmt' : 'double' ,
		'OvrsOptXrcRsvTpCode' : 'char'
	}
}
# 해외선물 예수금/잔고현황
db_outblock_query_CIDBQ03000 = {
	'CIDBQ03000OutBlock1' : {
		'RecCnt' : 'long' ,
		'AcntTpCode' : 'char' ,
		'AcntNo' : 'char' ,
	...
	'CIDBQ03000OutBlock2' : {
		...
		'CrcyObjCode' : 'char' ,
		'OvrsFutsDps' : 'double' ,
		'CustmMnyioAmt' : 'double' ,
		'AbrdFutsLqdtPnlAmt' : 'double' ,
		'AbrdFutsCmsnAmt' : 'double' ,
		'PrexchDps' : 'double' ,
		'EvalAssetAmt' : 'double' ,
		'AbrdFutsCsgnMgn' : 'double' ,
		'AbrdFutsAddMgn' : 'double' ,
		'AbrdFutsWthdwAbleAmt' : 'double' ,
		'AbrdFutsOrdAbleAmt' : 'double' ,
		'AbrdFutsEvalPnlAmt' : 'double' ,
		'LastSettPnlAmt' : 'double' ,
		'OvrsOptSettAmt' : 'double' ,
		'OvrsOptBalEvalAmt' : 'double'
	}
}
# 해외선물 계좌예탁자산조회
db_outblock_query_CIDBQ05300 = {
	'CIDBQ05300OutBlock1' : {
		'RecCnt' : 'long' ,
		'OvrsAcntTpCode' : 'char' ,
		'FcmAcntNo' : 'char' ,
	...
	'CIDBQ05300OutBlock2' : {
		...
		'OvrsFutsDps' : 'double' ,
		'AbrdFutsCsgnMgn' : 'double' ,
		'OvrsFutsSplmMgn' : 'double' ,
		'CustmLpnlAmt' : 'double' ,
		'AbrdFutsEvalPnlAmt' : 'double' ,
		'AbrdFutsCmsnAmt' : 'double' ,
		'AbrdFutsEvalDpstgTotAmt' : 'double' ,
		'Xchrat' : 'double' ,
		'FcurrRealMxchgAmt' : 'double' ,
		'AbrdFutsWthdwAbleAmt' : 'double' ,
		'AbrdFutsOrdAbleAmt' : 'double' ,
		'FutsDueNarrvLqdtPnlAmt' : 'double' ,
		'FutsDueNarrvCmsn' : 'double' ,
		'AbrdFutsLqdtPnlAmt' : 'double' ,
		'OvrsFutsDueCmsn' : 'double' ,
		'OvrsFutsOptBuyAmt' : 'double' ,
		'OvrsFutsOptSellAmt' : 'double' ,
		'OptBuyMktWrthAmt' : 'double' ,
		'OptSellMktWrthAmt' : 'double'
	},
	'CIDBQ05300OutBlock3' : {
		'RecCnt' : 'long' ,
		'OvrsFutsDps' : 'double' ,
...
db_outblock_query_CIDEQ00800 = {
	...
	'CIDEQ00800OutBlock2' : {
		...
		'DueDt' : 'char' ,
		'PrcntrAmt' : 'double' ,
		'FcurrEvalPnlAmt' : 'double'
	}
}

# 해외선물차트용NTick(o3117)
db_outblock_query_o3117 = {
	'o3117OutBlock' : {
		'shcode' : 'char' ,
		'rec_count' : 'long' ,
		'cts_seq' : 'char' ,
